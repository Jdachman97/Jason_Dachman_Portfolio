...
namespace CPI311.GameEngine
{
    public class Player : GameObject
    {
        ...
        public Player(ContentManager Content, Camera camera, GraphicsDevice graphicsDevice, Light light) : base()
        {
            ...
            sphereCollider.Radius = renderer.ObjectModel.Meshes[0].BoundingSphere.Radius * Constants.ShipBoundingSphereScale;
        ...
        public override void Update()
        {
            if (isActive)
            {
                ...
                {
                    this.Transform.Rotate(Vector3.Up, Time.ElapsedGameTime * Constants.shipRotateSpeed);
                }
                if (InputManager.IsKeyDown(Keys.D))
                {
                    this.Transform.Rotate(Vector3.Down, Time.ElapsedGameTime * Constants.shipRotateSpeed);
                }
