            ...
            if (other is SphereCollider)
            {
                ...
                for (int i = 0; i < 6; i++)
                {
                    for (int j = 0; j < 2; j++)
                    {
                        ...
                        Vector3 a = Vector3.Transform(vertices[indices[baseIndex]] * Size, Transform.World);
                        Vector3 b = Vector3.Transform(vertices[indices[baseIndex + 1]] * Size, Transform.World);
                        Vector3 c = Vector3.Transform(vertices[indices[baseIndex + 2]] * Size, Transform.World);
                        Vector3 n = Vector3.Transform(normals[i], Transform.World);
